...
public class OneBotGuildMeta
{
    ...
    [JsonPropertyName("guild_profile")] public string? GuildProfile { get; set; }

    [JsonPropertyName("create_time")] public long CreateTime { get; set; }

    [JsonPropertyName("max_member_count")] public long MaxMemberCount { get; set; }

    [JsonPropertyName("max_robot_count")] public long MaxRobotCount { get; set; }

    [JsonPropertyName("max_admin_count")] public long MaxAdminCount { get; set; }
